...
final class Pojo_A11y_Frontend {
	...
	public function print_skip_to_content_link() {
		...
		?>
		<a id="pojo-a11y-skip-content" class="pojo-skip-link pojo-skip-content" tabindex="1" accesskey="s" href="#content" alt='Saltar a contenido'><?php esc_html_e( 'Saltar a contenido', 'pojo-accessibility' ); ?></a>
		<?php
	}
	...
	public function print_toolbar() {
		...
		<nav id="pojo-a11y-toolbar" class="<?php echo esc_attr( implode( ' ', $wrapper_classes ) ); ?>" role="navigation">
			<div class="pojo-a11y-toolbar-toggle">
				<a class="pojo-a11y-toolbar-link pojo-a11y-toolbar-toggle-link" href="javascript:void(0);" title="<?php echo esc_attr( $toolbar_title ); ?>" alt='<?php echo esc_attr( $toolbar_title ); ?>'>
					<span class="pojo-sr-only sr-only"><?php esc_html_e( 'Abrir panel', 'pojo-accessibility' ); ?></span>
